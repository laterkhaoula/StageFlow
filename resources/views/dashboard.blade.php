        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="text-sm text-gray-500">Nombre de candidatures</div>
                    <div class="mt-2 text-3xl font-bold text-gray-900">{{ $totalCandidatures }}</div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="mt-2 text-3xl font-bold text-blue-600">{{ $offresActives }}</div>
                </div>
            </div>
        </div>
    </div>
